...
from treegp.bcm.run_seismic import load_seismic_locations, select_subset, dist_km
...
def main():
    ...
    C0 = np.load("seismic_experiments/3000_300_0.0000_default_cov/step_00033_cov.npy")
    ...
    mbcm =  MultiSharedBCM(X1, Y1, [(0, npts)],
                           cov, nv,
                           neighbor_threshold=0.0,
                           nonstationary=False,
                           kernelized=False)

    gpll, _, _ = mbcm.gaussian_llgrad(X1, Y1)
